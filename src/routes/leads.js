...
const SECRET_ENV_KEYS = ['ADMIN_API_TOKEN', 'ADMIN_PASSWORD', 'WHATSAPP_ACCESS_TOKEN', 'OPENAI_API_KEY', 'GEMINI_API_KEY',
  ...
  'ZOHO_REFRESH_TOKEN', 'ZOHO_ACCESS_TOKEN', 'ZOHO_AUTHORIZATION_CODE', 'ZOHO_AUTH_CODE',
  'ZOHO_BOOKS_CLIENT_ID', 'ZOHO_BOOKS_CLIENT_SECRET', 'ZOHO_BOOKS_REFRESH_TOKEN', 'ZOHO_BOOKS_ACCESS_TOKEN',
  'ZOHO_BOOKS_AUTHORIZATION_CODE', 'BOOKS_PASSWORD', 'DATABASE_URL', 'MONGODB_URI'];
